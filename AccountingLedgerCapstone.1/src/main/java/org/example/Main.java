...
import static org.example.Transactions.searchTransactionsByDate;
import static org.example.Transactions.searchTransactionsByVendor;

public class Main {

    public static void addDeposit(ArrayList<Transactions> transactions, String depositDate, String depositTime, String depositDescription, String depositVendor, double deposit) {
        transactions.add(new Transactions(depositDate, depositTime, depositDescription, depositVendor, "$" + deposit));
    }
    public static void addPayment(ArrayList<Transactions> transactions, String payDate, String payTime, String payDescription, String payVendor, double payment) {
        transactions.add(new Transactions(payDate, payTime, payDescription, payVendor, "-$" + payment));
    }
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                case 1 -> {
                    System.out.println("Enter the date 00-00-0000");
                    String depositDate = scanner.nextLine();
                    System.out.println("Enter the time 00:00");
                    ...
                    addDeposit(transactions, depositTime, depositDate, depositDescription, depositVendor, deposit);
                    System.out.println("Deposit Info: " + depositDate +" "+ depositDescription +" "+ depositVendor+" "+ deposit);
                ...
                case 2 -> {
                    ...
                    System.out.println("Enter time of withdrawal (00:00)");
                    ...
                    addPayment(transactions, payDate, payTime, payDescription, payVendor, payment);
                    System.out.println("Withdrawal Info: " + payDate +" "+ payDescription +" "+ payVendor+" "+ payment);
                    System.out.println("Your new balance is: $" + customerAccount.getBalance());
                }
                ...
                case 3 -> {
                    ...
                    if (ledgerView.equals("D")) {
                        ...
                        System.out.println("(1)Search By Vendor  (2)Search by Date  (0)Back");
                        ...
                        String reportsOption = scanner.nextLine();
                            ...
                            case "2" -> {
                                ...
                                searchTransactionsByDate(transactions, dateInput);
                            }
                            case "0" -> {
                                break;
